...
public class MyListAdapter extends ArrayAdapter<typegorngo> {

    //the list values in the List of type hero
    List<typegorngo> List;
    ...
    public MyListAdapter(Context context, int resource, List<typegorngo> List) {
    ...
    public View getView(final int position,  View convertView, ViewGroup parent) {
        ...
        typegorngo type = List.get(position);
